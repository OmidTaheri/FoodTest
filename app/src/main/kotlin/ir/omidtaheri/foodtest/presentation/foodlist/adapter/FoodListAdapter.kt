package ir.omidtaheri.foodtest.presentation.foodlist.adapter
...
import ir.omidtaheri.foodtest.databinding.FoodListEmptyStateBinding
import ir.omidtaheri.foodtest.databinding.FoodListItemBinding


class FoodListAdapter(private val context: Context, private val clickListener: Callback) :
        ...
        when (viewType) {
            ViewTypes.VIEW_TYPE_ITEM -> {
                ...
                return EmptyViewHolder(
                    FoodListEmptyStateBinding.inflate(
                        LayoutInflater.from(parent.context),
                        parent,
                        false
                    )
    ...
    inner class ItemViewHolder(private val binding: FoodListItemBinding) :
    ...
    inner class EmptyViewHolder(private val binding: FoodListEmptyStateBinding) :
        BaseViewHolder(binding.root) {
